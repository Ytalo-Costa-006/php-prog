...
<body class="bg-gray-700 text-white flex flex-col items-center justify-center w-full min-h-dvh">
	<form action="login.php" method="post">
		<div class="flex flex-col justify-center gap-5 p-5">
			...
			<input type="text" placeholder="Email" class="p-2 placeholder:text-gray-400 bg-gray-700 border rounded-md border-gray-950 outline-none focus:border-gray-600">
