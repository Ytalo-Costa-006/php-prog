...
<body class= "bg-gray-700 flex flex-col items-center justify-center w-full min-h-dvh">
		<div class="flex flex-col gap-5 p-5">
			<div class="flex flex-col gap-5 p-5">
				...
				<form class="flex flex-col gap-5 p-5" action="inserir_categoria.php">
					<input required type="text" name="categoria" placeholder="Nome da categoria" class="mt-10 bg-gray-700 text-gray-50 p-3 border rounded-md border-gray-950">
